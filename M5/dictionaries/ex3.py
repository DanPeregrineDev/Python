...
print(f"O Jogador1 lançou os dados e calharam os seguintes numeros: {resultados['Jogador1']}")
print(f"O Jogador2 lançou os dados e calharam os seguintes numeros: {resultados['Jogador2']}")
print(f"O Jogador3 lançou os dados e calharam os seguintes numeros: {resultados['Jogador3']}")
print(f"O Jogador4 lançou os dados e calharam os seguintes numeros: {resultados['Jogador4']}")
